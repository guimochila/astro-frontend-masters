...
import { $cart as cart, removeItemFromCard, subtotal } from '../stores/cart';
  ...
  return (
    <>
      ...
      <p class={styles.empty}>
        Your cart is empty! Add a sandwich kit or two and give a flavor chance.
      </p>
    </>
  );
};
            ...
            return (
              <li class={styles.item}>
                ...
                <span class={styles.remove}>
                  <button
                    title="remove item"
                    onClick={() => removeItemFromCard(entry.item.id)}
                  >
                    &times;
                  </button>
                </span>
